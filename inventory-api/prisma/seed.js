...
const permissionDefinitions = [
  ...
  ['users.view', 'users', 'view', 'Ver usuarios de la empresa'],
  ['users.create', 'users', 'create', 'Crear usuarios en la empresa'],
  ['users.update', 'users', 'update', 'Editar informacion de usuarios'],
  ['users.assign-role', 'users', 'assign_role', 'Asignar rol a usuario'],
  ['roles.view', 'roles', 'view', 'Consultar roles y permisos disponibles'],
  ['roles.manage', 'roles', 'manage', 'Crear y editar roles de la empresa'],
  ...
  ['clients.create', 'clients', 'create', 'Crear clientes y tiendas'],
  ['clients.edit', 'clients', 'edit', 'Editar informacion de clientes'],
  ['clients.references.create', 'clients', 'references_create', 'Agregar referencias a clientes'],
  ['clients.documents.upload', 'clients', 'documents_upload', 'Subir documentos de clientes'],
  ['clients.documents.download', 'clients', 'documents_download', 'Descargar documentos de clientes'],
  ['clients.delete', 'clients', 'delete', 'Eliminar clientes mediante soft delete'],
  ...
  ['products.sourcing.view', 'products', 'sourcing_view', 'Ver clasificacion de abastecimiento del producto'],
  ['products.sourcing.manage', 'products', 'sourcing_manage', 'Gestionar clasificacion de abastecimiento del producto'],
  ['suppliers.view', 'procurement', 'view_suppliers', 'Ver proveedores autorizados'],
  ['suppliers.manage', 'procurement', 'manage_suppliers', 'Gestionar proveedores y autorizaciones por producto'],
  ['recipes.view', 'production', 'view_recipes', 'Ver recetas y versiones'],
  ['recipes.operations.view', 'production', 'view_recipe_ops', 'Consultar formulas operativas congeladas'],
  ['recipes.manage', 'production', 'manage_recipes', 'Gestionar recetas y versiones'],
  ['recipes.approve', 'production', 'approve_recipes', 'Aprobar versiones de receta'],
  ['production.view', 'production', 'view_orders', 'Ver ordenes de produccion'],
  ['production.create', 'production', 'create_orders', 'Crear ordenes de produccion'],
  ['production.approve', 'production', 'approve_orders', 'Aprobar ordenes de produccion'],
  ['production.execute', 'production', 'execute', 'Ejecutar produccion'],
  ['production.complete', 'production', 'complete', 'Completar produccion'],
  ['production.cancel', 'production', 'cancel', 'Cancelar produccion'],
  ['production.override', 'production', 'override', 'Sobrescribir guardas de produccion'],
  ['quality.view', 'quality', 'view', 'Ver inspecciones QA'],
  ['quality.inspect', 'quality', 'inspect', 'Registrar inspecciones QA'],
  ['quality.override', 'quality', 'override', 'Sobrescribir bloqueo QA'],
  ['procurement.view', 'procurement', 'view', 'Ver solicitudes y ordenes de compra'],
  ['procurement.approve', 'procurement', 'approve', 'Aprobar seleccion de proveedor'],
  ['procurement.override', 'procurement', 'override', 'Sobrescribir guardas de compra'],
  ['warehouse.receive', 'warehouse', 'receive', 'Ejecutar recepciones y confirmar stock entrante'],
  ['receipts.view', 'warehouse', 'view_receipts', 'Ver documentos de recepcion'],
  ['receipts.inspect', 'warehouse', 'inspect_receipts', 'Inspeccionar recepciones'],
  ['receipts.confirm', 'warehouse', 'confirm_receipts', 'Confirmar entradas fisicas al inventario'],
  ['receipts.reverse', 'warehouse', 'reverse_receipts', 'Revertir entradas confirmadas'],
