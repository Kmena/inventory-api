...
El contrato versionado complementario de esta capacidad vive en `internal-docs/restore-readiness-baseline.md` y se valida con `npm run validate:restore-readiness`.
