...
const expectedHtmlFiles = ['agent/index.html', 'index.html', 'migration.html', 'no-access.html', 'root/index.html', 'supplier-quote/index.html', 'warehouse/index.html'];
const expectedJavaScriptFiles = [
  ...
  'root/entitlements-api.js',
  'root/feedback-api.js',
  'root/feedback-widget.js',
  'root/guards.js',
  ...
  'root/views/feedback-admin.js',
  'root/views/fiscal-refs-admin.js',
  'root/views/fiscal-refs-admin.renderers.js',
  'root/views/home.js',
  'root/views/in-process.js',
  'root/views/inventory-admin.helpers.js',
  'root/views/inventory-admin.js',
  'root/views/inventory-admin.renderers.js',
  ...
  'root/views/production-orders-admin.renderers.js',
  'root/views/production-orders-admin.state.js',
  'root/views/production-planner.js',
  ...
  'root/views/purchase-orders-admin.js',
  'root/views/purchase-orders-admin.renderers.js',
  'root/views/purchase-requests-admin.js',
  'root/views/purchase-requests-admin.renderers.js',
  'root/views/quotations-admin.helpers.js',
  'root/views/quotations-admin.js',
  'root/views/quotations-admin.renderers.js',
  'root/views/quotations-comparison.js',
  'root/views/quotations-comparison.renderers.js',
  ...
  'root/views/recipes-admin.state.js',
  'root/views/recipes-admin.version-editor.js',
  'root/views/rfq-tracking-admin.js',
  'root/views/rfq-tracking-admin.renderers.js',
  ...
  'root/views/suppliers-admin.helpers.js',
  'root/views/suppliers-admin.js',
  'root/views/suppliers-admin.renderers.js',
  'root/views/users-admin.helpers.js',
  'root/views/users-admin.js',
  ...
  'warehouse/views/production.controllers.rejection.js',
  'warehouse/views/production.exec-helpers.js',
  'warehouse/views/production.js',
  'warehouse/views/production.renderers.js',
  'warehouse/views/production.renderers.rejection.js',
  'warehouse/views/production.state.js',
  'warehouse/views/receipts.js',
  'warehouse/views/receive-from-po.js',
...
function validatePublicRuntimeInventory() {
  ...
  // Legacy HTML-only warehouse runtime remains retired, but the supported warehouse/QA SPA now lives at src/public/warehouse/.
