...
| FR-005 | `.env.production.example`, `scripts/validate-production-baseline.js`, `docs/production-baseline.md`, `docs/production-operations-runbook.md`, `README.md` | production baseline validation with explicit env + characterization tests | Completed |
...
| FR-007 | `/.github/workflows/operational-smoke.yml` preserved; validators only updated | workflow contract review + local validator pass | Completed |
