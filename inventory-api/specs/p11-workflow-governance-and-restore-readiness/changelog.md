...
## Draft
- Created initial specification package for workflow governance convergence and restore-readiness smoke repair.
- Captured current drift between root workflows, duplicated application-local workflows, and restore-readiness documentation/validator contracts.
