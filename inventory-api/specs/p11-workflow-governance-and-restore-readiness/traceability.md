...
| FR-005 | `package.json`, `operational-smoke.yml` | hosted/local smoke validation | Completed; hosted `operational-smoke` run `30288569602` |
...
| Hosted evidence | `operational-smoke` run `30288569602` succeeded and no longer fails for the prior missing-script defect |
