...
function renderIcon(iconName) {
  const iconPaths = {
    ...
    'file-search': '<path d="M14 2v4a2 2 0 0 0 2 2h4"/><path d="m10.4 21H6a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h8l6 6v3.5"/><circle cx="16.5" cy="17.5" r="2.5"/><path d="M18.4 19.4 21 22"/>',
    ...
    'package-check': '<path d="m16 16 2 2 4-4"/><path d="M21 10V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l2-1.14"/><path d="M16.5 9.4 7.55 4.24"/><polyline points="3.29 7 12 12 20.71 7"/><line x1="12" x2="12" y1="22" y2="12"/>',
