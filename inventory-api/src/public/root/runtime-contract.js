(function attachRootShellRuntimeContract(globalScope) {
  ...
  const loaderScripts = Object.freeze([
    ...
    },
    {
      ...
      requiresModules: ['recipesApi', 'productsApi', 'ui', 'sessionAdapter', 'views.recipesAdminHelpers', 'views.recipesAdminRenderers', 'views.recipesAdminState'],
      requiresScripts: ['/root/registry.js', '/root/recipes-api.js', '/root/products-api.js', '/root/ui.js', '/root/session-adapter.js', '/root/views/recipes-admin.helpers.js', '/root/views/recipes-admin.state.js', '/root/views/recipes-admin.renderers.js'],
    },
    {
