(function attachRootShellRuntimeContract(globalScope) {
  ...
  const loaderScripts = Object.freeze([
    ...
    },
    {
      ...
      registers: ['router'],
      requiresModules: ['manifest', 'guards', 'views.home', 'views.inProcess', 'views.companiesAdmin', 'views.rolesAdmin', 'views.zonesAdmin', 'views.agentsAdmin', 'views.clientsAdmin', 'views.routesAdmin', 'views.warehousesAdmin', 'views.productsAdmin', 'views.lotsAdmin', 'views.movementsAdmin'],
      requiresScripts: ['/root/registry.js', '/root/manifest.js', '/root/guards.js', '/root/views/home.js', '/root/views/in-process.js', '/root/views/companies-admin.js', '/root/views/roles-admin.js', '/root/views/zones-admin.js', '/root/views/agents-admin.js', '/root/views/clients-admin.js', '/root/views/routes-admin.js', '/root/views/warehouses-admin.js', '/root/views/products-admin.js', '/root/views/lots-admin.helpers.js', '/root/views/lots-admin.state.js', '/root/views/lots-admin.renderers.js', '/root/views/lots-admin.js', '/root/views/movements-admin.js'],
    },
    {
      path: '/root/app.js',
