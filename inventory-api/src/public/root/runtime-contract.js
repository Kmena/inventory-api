(function attachRootShellRuntimeContract(globalScope) {
  ...
  const loaderScripts = Object.freeze([
    ...
    {
      path: '/root/suppliers-api.js',
      category: 'provider',
      registers: ['suppliersApi'],
      requiresModules: [],
      requiresScripts: ['/shared/auth.js', '/root/registry.js'],
    },
    {
    ...
    {
      path: '/root/views/suppliers-admin.helpers.js',
      category: 'view-provider',
      registers: ['views.suppliersAdminHelpers'],
      requiresModules: [],
      requiresScripts: ['/root/registry.js'],
    },
    {
      path: '/root/views/suppliers-admin.renderers.js',
      category: 'view-provider',
      registers: ['views.suppliersAdminRenderers'],
      requiresModules: ['ui', 'views.suppliersAdminHelpers'],
      requiresScripts: ['/root/registry.js', '/root/ui.js', '/root/views/suppliers-admin.helpers.js'],
    },
    {
      path: '/root/views/suppliers-admin.js',
      category: 'view-provider',
      registers: ['views.suppliersAdmin'],
      requiresModules: ['suppliersApi', 'ui', 'sessionAdapter', 'views.suppliersAdminHelpers', 'views.suppliersAdminRenderers'],
      requiresScripts: ['/root/registry.js', '/root/suppliers-api.js', '/root/ui.js', '/root/session-adapter.js', '/root/views/suppliers-admin.helpers.js', '/root/views/suppliers-admin.renderers.js'],
    },
    {
    ...
    {
      path: '/root/views/production-planner.js',
      category: 'view-provider',
      registers: ['views.productionPlanner'],
      requiresModules: ['productsApi', 'productionAdminApi', 'warehousesApi', 'recipesApi', 'ui', 'usersApi'],
      requiresScripts: ['/root/registry.js', '/root/products-api.js', '/root/production-admin-api.js', '/root/warehouses-api.js', '/root/recipes-api.js', '/root/ui.js'],
    },
    {
