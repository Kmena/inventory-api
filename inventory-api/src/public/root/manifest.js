(function attachRootShellManifest(globalScope) {
  ...
  const usersItem = createRouteItem({
    ...
    visibilityRule: (session) => guards.hasPermission(session, 'users.view'),
    actorScope: 'permission:users.view',
    icon: 'user-cog',
    includeInRootNav: false,
    includeInLanding: true,
  ...
  const rolesPermissionsItem = createRouteItem({
    ...
    visibilityRule: (session) => guards.hasPermission(session, 'roles.view'),
    actorScope: 'permission:roles.view',
    icon: 'shield-check',
    includeInRootNav: false,
