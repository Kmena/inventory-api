...
function buildImportedProductData(row, companyId, category, auth) {
  ...
  return {
    ...
    presentationType: normalizeOptionalString(row.presentationType) ?? null,
    netContentUnit: normalizeOptionalString(row.netContentUnit) ?? null,
    requiresLot,
...
function buildProductWriteData(payload, auth, existingProduct) {
  ...
  return {
    ...
    presentationType: payload.presentationType ?? existingProduct?.presentationType ?? null,
    netContentUnit: payload.netContentUnit ?? existingProduct?.netContentUnit ?? null,
    requiresLot,
